...
export const Types: Record<TypeName, Type> = {
  ...
  footPressure: {
    ...
    name: 'footPressure',
    label: '足壓門診',
    tabs: ['clientInfo', 'footPressure', 'bodyAnalysis', 'memo', 'pointsGroup'],
    canUsePoint: false,
    calcAmount: () => 2000,
    spaceType: SpaceType['物理診所'],
    showInOptions: true,
  ...
  nutrition: {
    ...
    name: 'nutrition',
    label: '營養門診',
    tabs: ['clientInfo', 'nutritionClinic', 'bodyAnalysis', 'memo', 'pointsGroup'],
    canUsePoint: true,
    calcAmount: usePoint => usePoint ? 1 : 2000,
    spaceType: SpaceType['物理診所'],
    showInOptions: true,
  ...
  sleep: {
    ...
    name: 'sleep',
    label: '睡眠門診',
    tabs: ['clientInfo', 'sleepClinic', 'bodyAnalysis', 'memo', 'pointsGroup'],
    canUsePoint: false,
    calcAmount: () => 2000,
    spaceType: SpaceType['物理診所'],
    showInOptions: true,
  ...
  InternshipClinic: {
    ...
    name: 'physicalTherapy',
    label: '新人實習門診',
    tabs: ['clientInfo', 'medicalRecord', 'bodyAnalysis', 'memo', 'pointsGroup'],
    canUsePoint: false,
    calcAmount: () => 200,
    spaceType: SpaceType['物理診所'],
    showInOptions: true,
