  ...
  <QCard flat bordered class="info">
    ...
    >
      ...
      >
        <KeepAlive>
          <Suspense>
            <component :is="recordModules[tab.name]" :schedule-id="+scheduleId" :schedule-detail="appointmentStore.targetClientSchedule" @save=" appointmentStore.getClientSchedule(+props.scheduleId)" />
          </Suspense>
        </KeepAlive>
      </QTabPanel>
    </QTabPanels>
