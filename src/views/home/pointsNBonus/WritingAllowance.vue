...
import { type WritingAllowance, deleteWritingAllowance, getWritingAllowance, getWritingAllowanceList } from '@/api';
...
const list = ref<WritingAllowance[]>([]);
    ...
    <section>
      ...
      >
        ...
        <template #body-cell-action="{ row }">
          <QTd auto-width>
            <QBtn v-if="userStore.canI('EDIT_WRITING_ALLOWANCE')" flat round icon="o_delete" class="q-mr-sm" @click="deleteConfirm(row.id)" />
            <QBtn v-if="userStore.canI('EDIT_WRITING_ALLOWANCE')" flat round icon="o_edit" @click="editBonus(row.id)" />
          </QTd>
        </template>
      </QTable>
    </section>
